...
*/
(function() {
    function T(a, c) { a.prototype = Ra(c.prototype);
    ...
    function Q(a, c) { var b = !1;
        0 > a && (b = !0, a *= -1);
        a = "" + a; for (c = c ? c : 1; a.length < c;) a = "0" + a; return b ? "-" + a : a }

    function ma(a) { if (!a) return a;
    ...
    function G(a) { var c = ((a & 16711680) >> 16).toString(16),
    ...
    function L(a, c, b, d) { return a.addEventListener ? (a.addEventListener(c, b, d || !1), b) : a.attachEvent ? (d = function(d) { d = d || window.event;
    ...
    function ua(a, c, b) { if (w && Pa) { var d = a.getContext("2d");
            ...
            a.width = c * M;
            a.height = b * M;
            Ca !== va && (a.style.width = c + "px", a.style.height = b + "px", d.scale(M, M)) } else a.width = c, a.height = b }
    ...
    function K(a, c, b, d) { this._defaultsKey = a;
        this.parent = d;
        ...
        if (this.container = "string" === typeof this._containerId ? document.getElementById(this._containerId) : this._containerId) {
            ...
            this.canvas.getContext && (this._canvasJSContainer.appendChild(this.canvas), this.ctx = this.canvas.getContext("2d"), this.ctx.textBaseline = "top", Ka(this.ctx), w ? this.plotArea.ctx = this.ctx : (this.plotArea.canvas = ia(d, f), this.plotArea.canvas.style.position = "absolute", this.plotArea.canvas.setAttribute("class", "plotAreaCanvas"), this._canvasJSContainer.appendChild(this.plotArea.canvas),
                ...
                this._toolBar.style.cssText = "position: absolute; right: 1px; top: 1px;", this._canvasJSContainer.appendChild(this._toolBar), this.bounds = { x1: 0, y1: 0, x2: this.width, y2: this.height }, L(this.overlaidCanvas, "click", function(a) { b._mouseEventHandler(a) }), L(this.overlaidCanvas, "mousemove", function(a) { b._mouseEventHandler(a) }), L(this.overlaidCanvas, "mouseup", function(a) { b._mouseEventHandler(a) }), L(this.overlaidCanvas, "mousedown", function(a) { b._mouseEventHandler(a);
                    ba(b._dropdownMenu) }), L(this.overlaidCanvas, "mouseout",
    ...
    function la(a, c, b, d, f) { "undefined" === typeof f && (f = 0);
        this._padding = f;
        this._x1 = a;
        this._y1 = c;
        this._x2 = b;
    ...
    function W(a, c) { W.base.constructor.call(this, "TextBlock", c);
        this.ctx = a;
        this._isDirty = !0;
    ...
    function ya(a, c) { ya.base.constructor.call(this, "Subtitle", c, a.theme, a);
        this.chart = a;
        ...
        fa = function(a, c, b) {
            ...
            for (var y = 0; m && y < m.length; y++)
                if (c = m[y], "." === c && 0 > h) h = y;
                    ...
                    if ("%" === c) k *= 100;
                    else if ("\u2030" === c) { k *= 1E3; continue } else if ("," === c[0] && "." === c[c.length - 1]) { k /= Math.pow(1E3, c.length - 1);
                        h = y + c.length - 1; continue } else "E" !== c[0] && "e" !== c[0] || "0" !== c[c.length - 1] || (r = !0);
            ...
            for (r = m = y = e = h = 0; 0 < l.length;)
                if (c = l.pop(), "#" === c || "0" === c)
                    if (h++, h === n) { var v = k,
                            k = []; if ("0" === c)
                            for (c = n - e - (v ? v.length : 0); 0 < c;) v.unshift("0"), c--; for (; 0 < v.length;) b = v.pop() + b, r++, 0 === r % m && (y === q && 0 < v.length) && (b = g + b) } else 0 < k.length ? (b = k.pop() + b, e++, r++) :
    ...
    (function() {
        function a(a) {
            ...
            if (f && 0 < f.length || b) {
                ...
                if (!u(da[t.ckDec(t.str.sk)]) &&
                    "string" === typeof da[t.ckDec(t.str.sk)] && da[t.ckDec(t.str.sk)]) { g = da[t.ckDec(t.str.sk)]; for (var k = [], m = [], f = 0, l = h = "", p = g.substr(g.length - 3, g.length), n = 0; n < g.length - 3; n++) k.push(parseInt(g.charCodeAt(n)) - 59), h += String.fromCharCode(k[n]), f += parseInt(parseInt(h.charCodeAt(n)) + 59, 10);
                    f %= 256;
                    f = 99 < f ? "" + f : 9 < f ? "0" + f : "00" + f; for (n = 0; n < p.length; n++) m.push(parseInt(p.charCodeAt(n)) - 59), l += String.fromCharCode(m[n]);
                    g = f === l ? h : 0 } else g = 0;
        ...
        t.fAWm = function(c) { if ("undefined" === typeof t.pro.sCH && !na) try { if (a(30)) { var b = c[t.fSDec(t.str.ct)];
                    b[t.fSDec(t.str.tBl)] = t.fSDec(t.str.tp);
                    b[t.fSDec(t.str.fnt)] = 11 + t.fSDec(t.str.fntStr);
                    b[t.fSDec(t.str.fSy)] = t.fSDec(t.str.gr);
                    b[t.fSDec(t.str.fTx)](t.fSDec(t.str.tv), 2, c.height - 11 - 2) } } catch (d) {} };
    ...
    K.prototype.setOptions = function(a, c) { if (S[this._defaultsKey]) { var b = S[this._defaultsKey],
    ...
    K.prototype.createUserOptions = function(a) {
        if ("undefined" !== typeof a || this.options._isPlaceholder)
            if (this.parent.options._isPlaceholder && this.parent.createUserOptions(),
                this.isOptionsInArray) { this.parent.options[this.optionsName] || (this.parent.options[this.optionsName] = []); var c = this.parent.options[this.optionsName],
                    b = c.length;
                this.options._isPlaceholder || (ta(c), b = c.indexOf(this.options));
                this.options = "undefined" === typeof a ? {} : a;
                c[b] = this.options } else this.options = "undefined" === typeof a ? {} : a, a = this.parent.options, this.optionsName ? c = this.optionsName : (c = this._defaultsKey) && 0 !== c.length ? (b = c.charAt(0).toLowerCase(), 1 < c.length && (b = b.concat(c.slice(1))), c = b) : c = void 0,
                a[c] = this.options
    };
    K.prototype.remove = function(a) { a = "undefined" === typeof a ? !0 : a; if (this.isOptionsInArray) { var c = this.parent.options[this.optionsName];
            ta(c); var b = c.indexOf(this.options);
    ...
    K.prototype.trackChanges = function(a) { if (!this.sessionVariables) throw "Session Variable Store not set";
    ...
    K.prototype.removeEventListener = function(a, c) { if (a && c && this._eventListeners[a])
    ...
    T(z, K);
    z.prototype.destroy = function() { var a = window,
    ...
    z.prototype._updateOptions = function() {
        ...
        if (!this._dropdownMenu && this.exportEnabled && w) {
            ...
            L(this._dropdownMenu, "blur", function() { ba(a._dropdownMenu);
            ...
            L(c, "mouseover", function() { this.style.backgroundColor = "#EEEEEE" }, !0);
            L(c, "mouseout", function() { this.style.backgroundColor = "transparent" }, !0);
            L(c, "click", function() { Da(a.canvas, "jpeg", a.exportFileName);
                ba(a._dropdownMenu) }, !0);
            c = document.createElement("div");
            c.style.cssText = "padding: 2px 15px 2px 10px";
            ...
            L(c, "mouseover", function() { this.style.backgroundColor = "#EEEEEE" }, !0);
            L(c, "mouseout", function() { this.style.backgroundColor = "transparent" }, !0);
            L(c, "click", function() { Da(a.canvas, "png", a.exportFileName);
                ba(a._dropdownMenu) }, !0)
        }
    ...
    z.prototype._initialize = function() {
        ...
        var g = this;
        this.addEventListener("dataAnimationIterationEnd", function() { t.fAWm && t.fAWm(g);
    ...
    z.prototype.render = function(a) {
        ...
        var d = [];
        if (this.animatedRender) { var f = ia(this.width, this.height);
            ...
            if (a = this.data[c], a.dataPoints && (0 !== a.dataPoints.length && a.visible) && 0 <= z._supportedChartTypes.indexOf(a.type)) {
                for (var b = null, d = !1, f = null, g = !1, k = 0; k < this.plotInfo.plotTypes.length; k++)
                    if (this.plotInfo.plotTypes[k].type === a.type) { d = !0;
                        b = this.plotInfo.plotTypes[k]; break }
                ...
                for (k = 0; k < b.plotUnits.length; k++)
                    if (b.plotUnits[k].axisYType ===
                        a.axisYType && b.plotUnits[k].axisXType === a.axisXType && b.plotUnits[k].axisYIndex === a.axisYIndex && b.plotUnits[k].axisXIndex === a.axisXIndex) { g = !0;
                        f = b.plotUnits[k]; break }
                g || (f = {
                    type: a.type,
    ...
    z.prototype.assignIdToDataPoints = function() { for (var a = 0; a < this.data.length; a++) { var c = this.data[a]; if (c.dataPoints)
        ...
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
            for (var c = a.axisY.dataInfo, b = a.axisX.dataInfo, d, f, g = !1, k = 0; k < a.dataSeriesIndexes.length; k++) {
                ...
                for (h = 0; h < m.dataPoints.length; h++) {
                    ...
                    if (0 < h) {
                        if (a.axisX.logarithmic) { var r = d / m.dataPoints[h - 1].x;
                            1 > r && (r = 1 / r);
                            b.minDiff > r && 1 !== r && (b.minDiff = r) } else r = d - m.dataPoints[h - 1].x, 0 > r && (r *= -1), b.minDiff > r && 0 !== r && (b.minDiff = r);
        ...
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
            for (var c = a.axisY.dataInfo, b = a.axisX.dataInfo, d, f, g = !1, k = [], m = [], h = Infinity, l = -Infinity, p = 0; p < a.dataSeriesIndexes.length; p++) {
                ...
                for (e = 0; e < n.dataPoints.length; e++) {
                    ...
                    d > b.max && (b.max = d);
                    if (0 < e) {
                        if (a.axisX.logarithmic) { var A = d / n.dataPoints[e - 1].x;
                            1 > A && (A = 1 / A);
                            b.minDiff > A && 1 !== A && (b.minDiff = A) } else A = d - n.dataPoints[e - 1].x, 0 > A && (A *= -1), b.minDiff >
                            A && 0 !== A && (b.minDiff = A);
    ...
    z.prototype.getDataPointAtXY = function(a, c, b) {
        b = b || !1;
        for (var d = [], f = this._dataInRenderedOrder.length - 1; 0 <= f; f--) { var g = null;
    ...
    z.prototype.clearCanvas = function() { this.ctx.clearRect(0, 0, this.width, this.height);
    ...
    z.prototype._touchEventHandler = function(a) {
        if (a.changedTouches && this.interactivityEnabled) {
            ...
            if (!(b && 1 < b.length)) {
                f = Aa(d);
                f.time = new Date;
                try { var g = f.y - this._lastTouchData.y; if (15 < Math.abs(g) && this._lastTouchData.scroll) { this._lastTouchData.scroll = !0; var k = window.parent || window;
                        k && k.scrollBy && k.scrollBy(0, -g) } } catch (m) {}
    ...
    z.prototype._plotAreaMouseDown = function(a, c) { this.isDrag = !0;
    ...
    z.prototype._plotAreaMouseUp = function(a, c) {
        if (("normal" === this.plotInfo.axisPlacement ||
            ...
            if (this.panEnabled || this.zoomEnabled) {
                ...
                else if ((!f || 2 < Math.abs(d)) && (!g || 2 < Math.abs(b)) && this.zoomEnabled) { if (!this.dragStartPoint) return;
    ...
    z.prototype.validateRegion = function(a, c, b, d, f) {
        ...
        for (g = 0; g < l.length; g++) { var k = l[g],
                n = k.convertPixelToValue({ x: a, y: c }),
                e = k.convertPixelToValue({ x: b, y: d }); if (n > e) var q = e,
                e = n,
                n = q; if (isFinite(k.dataInfo.minDiff))
    ...
    z.prototype.renderLine = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var d = [], f, g = 0; g < a.dataSeriesIndexes.length; g++) {
                ...
                var h = m.dataPoints,
                    l = "solid";
                if (c.setLineDash) { var p = H(m.nullDataLineDashType, m.lineThickness),
                        l = m.lineDashType,
    ...
    z.prototype.renderSpline = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var f = [], g = 0; g < a.dataSeriesIndexes.length; g++) {
                ...
                var h = m.dataPoints,
                    l = "solid";
                if (b.setLineDash) { var p = H(m.nullDataLineDashType, m.lineThickness),
                        l = m.lineDashType,
                        n = H(l, m.lineThickness);
                    b.setLineDash(n) }
                var e =
                    ...
                    for (y = !1, r = 0; r < h.length; r++)
                        if (s = h[r].getTime ? h[r].x.getTime() : h[r].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !y)))
                            if ("number" !== typeof h[r].y) 0 < r && !y &&
                                ...
                                if (0 < h[r].markerSize || 0 < m.markerSize) { var x = m.getMarkerProperties(r, s, y, b);
                                    f.push(x);
                                    A = G(A);
                                    w && f.push({ x: s, y: y, ctx: d, type: x.type, size: x.size, color: A, borderColor: A, borderThickness: x.borderThickness }) }(h[r].indexLabel || m.indexLabel || h[r].indexLabelFormatter || m.indexLabelFormatter) && this._indexLabels.push({
                                    chartType: "spline",
                                    dataPoint: h[r],
                                    dataSeries: m,
                                    point: { x: s, y: y },
                    ...
                    if (0 < r.length) {
                        ...
                        for (m = 0; m < r.length; m++)
                            if (b = r[m].x.getTime ? r[m].x.getTime() : r[m].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof r[m].y) {
                                ...
                                else if (h = a.axisY.convertValueToPixel(r[m].y), 0 <= r[m].y) { var x = f[b] ? f[b] : 0;
                                    h -= x;
                                    A = l - x;
                                    f[b] = x + (A - h) } else x = g[b] ? g[b] : 0, A = h + x, h = l + x, g[b] = x + (A - h);
                    ...
                    for (var s = 5 < n && q.bevelEnabled ?
                        ...
                        if (b = r[m].x.getTime ? r[m].x.getTime() : r[m].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof r[m].y) {
                            ...
                            var y = d - a.plotType.plotUnits.length * n / 2 + a.index * n << 0,
                                v = y + n << 0,
                                A;
                            if (a.axisY.logarithmic) { k[b] = h + (k[b] ? k[b] : 0); if (0 >= k[b]) continue;
                                h = a.axisY.convertValueToPixel(k[b]);
                                A = f[b] ? f[b] : l;
                                f[b] = h } else if (h = a.axisY.convertValueToPixel(h), 0 <= r[m].y) {
                                var x = f[b] ?
                                    f[b] : 0;
                                h -= x;
                                A = l - x;
                    ...
                    for (m = 0; m < r.length; m++)
                        if (b = r[m].x.getTime ? r[m].x.getTime() : r[m].x, !(b <
                            ...
                            if (a.axisY.logarithmic) k[b] = r[m].y + (k[b] ? k[b] : 0), 0 < k[b] && (A = f[b] ? f[b] : l, f[b] = h = a.axisY.convertValueToPixel(k[b]));
                                ...
                                A = l + x;
                                h += x;
                                f[b] = x + (h - A) } else x = g[b] ? g[b] : 0, A = h - x, h = l - x, g[b] = x + (h - A);
                            b = r[m].color ? r[m].color : q._colorSet[m % q._colorSet.length];
                ...
                if (0 < r.length) {
                    ...
                    for (m = 0; m < r.length; m++)
                        if (b = r[m].x.getTime ? r[m].x.getTime() : r[m].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof r[m].y) {
                            ...
                            } else if (h = a.axisY.convertValueToPixel(y), 0 <= r[m].y) { var x = f[b] ? f[b] : 0;
                                y = l + x;
                                h += x;
                                f[b] = x + (h - y) } else x = g[b] ? g[b] : 0, y = h - x, h = l - x, g[b] = x + (h - y);
                            b = r[m].color ? r[m].color : q._colorSet[m % q._colorSet.length];
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (l = 0; l < a.dataSeriesIndexes.length; l++) {
                ...
                if (0 < q.length) {
                    ...
                    b = "solid";
                    if (f.setLineDash) { var B = H(e.nullDataLineDashType, e.lineThickness);
                        b = e.lineDashType; var X = H(b, e.lineThickness);
                        f.setLineDash(X) }
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (m = 0; m < a.dataSeriesIndexes.length; m++) {
                ...
                if (0 < p.length) {
                    ...
                    var u = "solid";
                    if (b.setLineDash) { var D = H(l.nullDataLineDashType, l.lineThickness),
                            u = l.lineDashType,
                    ...
                    for (q = !1; n < p.length; n++)
                        if (e = p[n].x.getTime ? p[n].x.getTime() : p[n].x, !(e < a.axisX.dataInfo.viewPortMin || e > a.axisX.dataInfo.viewPortMax && (!l.connectNullData || !q)))
                            if ("number" !== typeof p[n].y) 0 < n && !q && (l.connectNullData ?
                                ...
                                if (0 !== p[n].markerSize && (0 < p[n].markerSize || 0 < l.markerSize)) { var X = l.getMarkerProperties(n, e, q, b);
                                    k.push(X);
                                    B = G(B);
                                    w && k.push({ x: e, y: q, ctx: d, type: X.type, size: X.size, color: B, borderColor: B, borderThickness: X.borderThickness }) }(p[n].indexLabel || l.indexLabel || p[n].indexLabelFormatter || l.indexLabelFormatter) && this._indexLabels.push({
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (l = 0; l < a.dataSeriesIndexes.length; l++) {
                ...
                if (0 < q.length) {
                    ...
                    f.lineWidth = e.lineThickness;
                    var U = "solid";
                    if (f.setLineDash) { var X = H(e.nullDataLineDashType, e.lineThickness),
                            U = e.lineDashType,
    ...
    z.prototype.renderStackedArea =
        function(a) {
            function c() { if (!(1 > m.length)) { for (0 < t.lineThickness && b.stroke(); 0 < m.length;) { var a = m.pop();
                        b.lineTo(a.x, a.y);
                        w && s.lineTo(a.x, a.y) }
                    b.closePath();
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                d = [];
                for (g = 0; g < a.dataSeriesIndexes.length; g++) { var x = a.dataSeriesIndexes[g],
                        t = this.data[x],
                        u = t.dataPoints;
                    t.dataPointIndexes = []; for (p = 0; p < u.length; p++) x = u[p].x.getTime ? u[p].x.getTime() : u[p].x, t.dataPointIndexes[x] = p, d[x] || (h.push(x), d[x] = !0);
                    h.sort(Ba) }
                for (g = 0; g < a.dataSeriesIndexes.length; g++) {
                    ...
                    if (0 < h.length) {
                        ...
                        A = "solid";
                        if (b.setLineDash) { var U = H(t.nullDataLineDashType, t.lineThickness);
                            A = t.lineDashType; var X = H(A, t.lineThickness);
                            b.setLineDash(X) }
                        for (var Y = !0, p = 0; p < h.length; p++) {
                            ...
                            if (!(q < a.axisX.dataInfo.viewPortMin || q > a.axisX.dataInfo.viewPortMax && (!t.connectNullData || !Y)))
                                if ("number" !== typeof I.y) t.connectNullData || (Y || v) || c(), Y = !0;
                                    ...
                                    var ga = k[q] ? k[q] : 0;
                                    if (a.axisY.logarithmic) { l[q] = I.y + (l[q] ? l[q] : 0); if (0 >= l[q]) continue;
                                        e = a.axisY.convertValueToPixel(l[q]) } else e = a.axisY.convertValueToPixel(I.y), e -= ga;
                                    m.push({ x: n, y: r - ga });
                                    k[q] = r - e;
                                    ...
                                    if (0 <= t.dataPointIndexes[q]) { var ha = t.dataPointIds[t.dataPointIndexes[q]];
    ...
    z.prototype.renderStackedArea100 = function(a) {
        function c() { for (0 < u.lineThickness && b.stroke(); 0 < m.length;) { var a = m.pop();
                b.lineTo(a.x, a.y);
                w && t.lineTo(a.x, a.y) }
            b.closePath();
    ...
    z.prototype.renderRangeArea = function(a) {
        function c() {
            if (t) {
                ...
                b.globalAlpha = 1;
                d.fill();
                if (0 < h.lineThickness) { b.beginPath();
                    b.moveTo(a.x, a.y); for (c = 0; c < k.length; c++) a = k[c], b.lineTo(a.x, a.y);
                    b.stroke() }
                b.beginPath();
                b.moveTo(e, q);
                d.beginPath();
        ...
        function c(a, c) {
            ...
            if (0 < e.length) {
                if (0 < m.lineThickness) {
                    ...
                    for (var f = 0; f < e.length - 3; f += 3) { if (e[f].newStrokeStyle || e[f].newLineDashArray) b.stroke(), b.beginPath(), b.moveTo(e[f].x, e[f].y), e[f].newStrokeStyle && (b.strokeStyle = e[f].newStrokeStyle), e[f].newLineDashArray && b.setLineDash(e[f].newLineDashArray);
                ...
                if (0 < m.lineThickness) {
                    ...
                    b.beginPath();
                    b.moveTo(e[0].x, e[0].y);
                    for (var g = f = 0; f < e.length - 3; f += 3, g++) { if (q[g].newStrokeStyle || q[g].newLineDashArray) b.stroke(), b.beginPath(), b.moveTo(e[f].x, e[f].y), q[g].newStrokeStyle && (b.strokeStyle = q[g].newStrokeStyle), q[g].newLineDashArray && b.setLineDash(q[g].newLineDashArray);
                        b.bezierCurveTo(e[f + 1].x, e[f + 1].y, e[f + 2].x, e[f + 2].y, e[f + 3].x, e[f + 3].y) }
                    b.stroke()
                }
                b.beginPath()
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (g = 0; g < a.dataSeriesIndexes.length; g++) {
                ...
                if (0 < h.length) {
                    ...
                    var u = "solid",
                        x;
                    if (b.setLineDash) { var z = H(m.nullDataLineDashType, m.lineThickness),
                            u = m.lineDashType;
    ...
    var Ia = function(a, c, b, d, f, g, k, m, h) {
        if (!(0 > b)) {
            ...
            if (!w) { var l = Number((k % (2 * Math.PI)).toFixed(8));
    ...
    z.prototype.renderPie = function(a) {
        function c() {
            if (l && p) {
                for (var a = 0, b = 0, c = 0, d = 0, f = 0; f < p.length; f++) {
                    ...
                    k.midAngle = g;
                    if (k.midAngle > Math.PI / 2 - v && k.midAngle < Math.PI / 2 + v) { if (0 === a || q[c].midAngle > k.midAngle) c = f;
                        a++ } else if (k.midAngle > 3 * Math.PI / 2 - v && k.midAngle < 3 * Math.PI / 2 + v) {
                        if (0 ===
        ...
        function f(a) { for (var b = null, c = 1; c < p.length; c++)
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            if (0 !== z) {
                ...
                this.pieDoughnutClickHandler = function(a) { h.isAnimating || !u(a.dataSeries.explodeOnClick) && !a.dataSeries.explodeOnClick || (a = a.dataPoint, a.exploded = a.exploded ? !1 : !0, 1 < this.dataPoints.length && h._animator.animate(0, 500, function(a) { b(a);
                        m() })) };
                c();
                k();
                k();
    ...
    W.prototype.measureText = function() { this._lineHeight = Ma(this.fontFamily, this.fontSize, this.fontWeight); if (null === this.maxWidth) throw "Please set maxWidth and height for TextBlock";
    ...
    W.prototype._wrapText = function() {
        ...
        if (0 === this.frontSize) f = d = 0;
            ...
            for (; 0 <
                a.length;) { var g = this.maxHeight - 2 * this.padding,
    ...
    T(Ea, K);
    Ea.prototype.render = function() { var a = this.chart.layoutManager.getFreeSpace();
        ...
        if ("undefined" === typeof this.options.interval) {
            ...
            if ("left" === this._position || "right" === this._position)
                if (this.logarithmic && !this.equidistantInterval && this.labelAutoFit) {
                    ...
                    this._labels = c
                } else { for (h = 0; h < this._labels.length; h++) p = this._labels[h], p.position < this.viewportMinimum || (p = p.textBlock.height * Math.abs(Math.cos(Math.PI / 180 * this.labelAngle)) + p.textBlock.width * Math.abs(Math.sin(Math.PI / 180 * this.labelAngle)), b += p);
    ...
    B.prototype.renderStripLinesOfThicknessType = function(a) {
        if (this.stripLines && 0 < this.stripLines.length && a) {
            for (var c = this, b, d = 0, f = 0, g = !1, k = !1, m = [], h = [], k = !1, d = 0; d < this.stripLines.length; d++) { var l = this.stripLines[d];
    ...
    B.prototype.setViewPortRange =
        function(a, c) { this.sessionVariables.newViewportMinimum = this.viewportMinimum = Math.min(a, c);
    ...
    B.prototype.calculateLogarithamicAxisParameters = function() {
        ...
        this.noTicks = a;
        if (!this.options.interval && this.range < Math.pow(this.logarithmBase, 8 > this.viewportMaximum || 3 > a ? 2 : 3)) { for (c = Math.floor(this.viewportMinimum / b + 0.5) * b; c < this.viewportMinimum;) c += b;
            this.equidistantInterval = !1;
            this.intervalStartPosition = c;
            this.interval = b } else this.options.interval || (b = Math.ceil(this.interval), this.range > this.interval && (this.interval = b, d = Math.pow(this.logarithmBase, Math.floor(Math.log(this.viewportMinimum) / (c * this.interval) + 0.2) * this.interval))),
            this.equidistantInterval = !0, this.intervalStartPosition = d;
        if (!this.valueFormatString && (this.valueFormatString = "#,##0.##", 1 > this.viewportMinimum)) { c = Math.floor(Math.abs(Math.log(this.viewportMinimum) / Math.LN10)) + 2; if (isNaN(c) || !isFinite(c)) c = 2; if (2 < c)
                for (b = 0; b < c - 2; b++) this.valueFormatString += "#" }
    };
    B.getNiceExponent = function(a, c) { var b = Math.floor(Math.log(a) / Math.LN10),
            d = a / Math.pow(10, b),
    ...
    B.getNiceNumber = function(a,
        c) { var b = Math.floor(Math.log(a) / Math.LN10),
            d = a / Math.pow(10, b); return Number(((c ? 1.5 > d ? 1 : 3 > d ? 2 : 7 > d ? 5 : 10 : 1 >= d ? 1 : 2 >= d ? 2 : 5 >= d ? 5 : 10) * Math.pow(10, b)).toFixed(20)) };
        ...
        if (!this.chart.disableToolTip) {
            ...
            if (this.shared &&
                ...
                if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                    f = [];
                    if (this.chart.axisX)
                        for (var m = 0; m < this.chart.axisX.length; m++) { for (var k = this.chart.axisX[m].convertPixelToValue({ y: c }), h = null, d = 0; d < this.chart.axisX[m].dataSeries.length; d++)(h = this.chart.axisX[m].dataSeries[d].getDataPointAtX(k, b)) && 0 <= h.index && (h.dataSeries = this.chart.axisX[m].dataSeries[d], null !== h.dataPoint.y && f.push(h));
                            h = null }
    ...
    z.prototype.getPercentAndTotal = function(a, c) {
        ...
        else if ("pie" === a.type || "doughnut" === a.type) { for (i = d = 0; i < a.dataPoints.length; i++) isNaN(a.dataPoints[i].y) || (d += a.dataPoints[i].y);
    ...
    z.prototype.replaceKeywordsWithValue = function(a, c, b, d, f) {
        ...
        if ((0 <= b.type.indexOf("stacked") || "pie" === b.type || "doughnut" === b.type) && (0 <= a.indexOf("#percent") || 0 <= a.indexOf("#total"))) {
            ...
            do { h = ""; if (b.percentFormatString) h = b.percentFormatString;
                else { var h = "#,##0.",
                        l = Math.max(Math.ceil(Math.log(1 / Math.abs(k)) / Math.LN10), 2); if (isNaN(l) || !isFinite(l)) l = 2; for (var p = 0; p < l; p++) h += "#";
                    b.percentFormatString = h }
                a = a.replace("#percent", fa(k, h, g._cultureInfo));
                a = a.replace("#total", fa(m, b.yValueFormatString ? b.yValueFormatString : "#,##0.########", g._cultureInfo)) } while (0 <= a.indexOf("#percent") || 0 <= a.indexOf("#total"))
        }
        return a.replace(/\{.*?\}|"[^"]*"|'[^']*'/g,
            function(a) {
                ...
                try { var h = a.match(/(.*?)\s*\[\s*(.*?)\s*\]/);
                    h && 0 < h.length && (e = ma(h[2]), a = ma(h[1])) } catch (k) {}
                h = null;
    ...
    oa.prototype.mouseEventHandler = function(a) {
        if ("mousemove" === a.type || "click" === a.type) {
            ...
            f = [];
            for (b = 0; b < this.mouseoveredObjectMaps.length; b++) { g = !0; for (d = 0; d < c.length; d++)
    ...
    Fa.prototype.cancelAllAnimations = function() { this.animations = [];
    ...
    var F = {
            ...
            xScaleAnimation: function(a, c) { if (0 !== a) { var b = c.dest,
                        d = c.source.canvas,
                        f = c.animationBase;
